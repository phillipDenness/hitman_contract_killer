...
_BLUPool=	["B_sniper_F","B_Soldier_A_F","B_Soldier_AA_F","B_Soldier_AAA_F","B_Soldier_AAR_F","B_Soldier_AAT_F","B_Soldier_AR_F","B_Soldier_AT_F","B_soldier_exp_F","B_Soldier_F","B_engineer_F","B_medic_F","B_recon_exp_F","B_recon_F","B_recon_JTAC_F","B_recon_LAT_F","B_recon_M_F","B_recon_medic_F","B_recon_TL_F"];

BLUFORmarkers=BLUFORmarkers call BIS_fnc_arrayShuffle;
_countMkrs=count BLUFORmarkers;
_counter=0;
{
_counter=_counter+1;
...
}foreach BLUFORmarkers;

_tempUnit=_BLUPool select (floor(random(count _BLUPool)));
